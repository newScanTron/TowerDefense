//
//  EnemyAttackSSBoss.swift
//  TowerDefense
//
//  Created by Tobias Kundig on 5/5/16.
...
class EnemyAttackSSBoss: EnemyAttackStrat{
    ...
    override func Die()  {
        ...
        for e in appDelegate!.sideScrollScene!.enemies{
            ...
            e.setMoveStrategy(EnemySSMoveStrat())
    ...
    override func Attack(){
        ...
        if(parent!.sprite.position.x < 1000){
            appDelegate!.sideScrollScene!.scene?.addChild(circle!)
        }
